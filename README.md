...
[![Version](https://img.shields.io/badge/version-R.1.1.1-blue?style=flat-square)](CHANGELOG.md)
...
- Current release: `R.1.1.1` — test suite verified against renamed Lindblad codebase; 94 tests across 16 suites, all passing
