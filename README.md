...
This project is licensed under the **[Lindblad Software License Agreement v2.2](LICENSE)** — source-available, free for non-commercial and academic use. Commercial use requires a separate license agreement.
