...
[![Version](https://img.shields.io/badge/version-R.1.3.1-blue?style=flat-square)](CHANGELOG.md)
...
- Current release: `R.1.3.1` — test suite release; 5 new test files, 223 tests across 35 suites; 193 passed, 30 failed
- Previous release: `R.1.3.0` — 15 correctness fixes across gates/simulators/algorithms/transpiler; 8 performance improvements; 3 documentation fixes
