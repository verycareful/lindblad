...
[![Version](https://img.shields.io/badge/version-1.1.29.2-blue?style=flat-square)](CHANGELOG.md)
...
| Physical-validity validation | [docs/api/validation.md](docs/api/validation.md) |
| Observation and the run harness | [docs/api/observation.md](docs/api/observation.md) |
| Circuit DAG | [docs/api/dag.md](docs/api/dag.md) |
| Hardware info | [docs/api/hw-info.md](docs/api/hw-info.md) |
...
|---|---|---|---|
| Eigen3 | 5.0.0 | MPL 2.0 | Dense linear algebra; selectable SVD kernels (`EigenBDC`, `EigenJacobi`) |
| autonne | 0.3.0 | Apache 2.0 | Default MPS SVD kernels (`BDC`, `Jacobi`) and the bond-split rescue |
| FLOP | 0.1.0.4 | MPL 2.0 | Default classical optimizer for VQE, QAOA and MA-QAOA (`COBYLA`) |
| NLopt | 2.7.1 | LGPL 2.1 | Alternative optimizers (`NLOPT_COBYLA`, `NELDER_MEAD`, `BOBYQA`) |
