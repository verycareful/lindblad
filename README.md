...
[![Version](https://img.shields.io/badge/version-R.1.3.0-blue?style=flat-square)](CHANGELOG.md)
...
- Current release: `R.1.3.0` — 15 correctness fixes across gates/simulators/algorithms/transpiler; 8 performance improvements; 3 documentation fixes
- Previous release: `R.1.2.2` — 3 regression patches (StatevectorSimulator sentinel, DeutschJozsa ancilla bitstring, BernsteinVazirani ancilla strip); 94/94 tests passing
